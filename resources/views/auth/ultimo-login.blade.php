...
<head>
    ...
    <title>ERP Carnicos SV SAS</title>
                        ...
                        <form class="text-left mt-5" action="{{ route('login') }}" method="POST">
                            ...
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="email" name="email" type="email" class="form-control @error('email') is-invalid @enderror" placeholder="usuario@pur*****s.com" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                    @error('email')
