...
class SalesXsCExport implements FromCollection, WithHeadings, WithCustomStartCell, WithTitle, WithStyles, WithEvents
{
    ...
    {
        return 'Consolidado Ventas por Subcentrocosto';
    }
